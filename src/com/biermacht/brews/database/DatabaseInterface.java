...
public class DatabaseInterface {
   ...
   */
  protected ArrayList<Ingredient> getIngredients(long dbid, String type) {
   ...
   * Returns ingredients from the given database with the given ingredient type
   */
  protected ArrayList<MashProfile> getMashProfiles(long dbid) {
   ...
   * Returns ingredients from the given database with the given ingredient type
   */
  protected ArrayList<Ingredient> getIngredients(long dbid) {
    ArrayList<Ingredient> list = new ArrayList<Ingredient>();
