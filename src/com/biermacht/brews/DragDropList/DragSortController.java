...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
   ...
   * calls {@link #dragHandleHitPosition(android.view.MotionEvent)}. Override to change drag handle
   * behavior; this function is called internally when an ACTION_DOWN event is detected.
   *
   * @param ev
