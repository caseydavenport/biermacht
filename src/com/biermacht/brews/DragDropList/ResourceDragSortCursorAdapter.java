...
public abstract class ResourceDragSortCursorAdapter extends DragSortCursorAdapter {
   ...
   * @param layout
   *         resource identifier of a layout file that defines the views for this list item.  Unless
   *         you override them later, this will define both the item views and the drop down views.
  ...
  /**
   * Constructor with default behavior as per {@link CursorAdapter#CursorAdapter(android.content.Context,
   * android.database.Cursor, boolean)}; it is recommended you not use this, but instead {@link
   * #ResourceCursorAdapter(android.content.Context, int, android.database.Cursor, int)}. When using
   ...
   * @param autoRequery
   *         If true the adapter will call requery() on the cursor whenever it changes so the most
   *         recent data is always displayed.  Using true here is discouraged.
   */
